          ...
          <section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
            <div className="flex flex-col items-center justify-center sm:text-center lg:items-start lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
              ...
              <p className="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">
                Indulge yourself with the finest rentals for every luxury
                occasion. At The Luxe Lender, you can rent coveted designer
                handbags, watches, jewelry, eyewear, and more without the
                commitment.
              </p>
